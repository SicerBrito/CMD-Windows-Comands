...
---
 ...
 - ## Comandos
    ...
    - ### Curiosos
    - ### Útiles
        Comando para ver la contraseña del WIFI con conexión Inalámbrica.
        - ```netsh wlan show profile``` Muestra la lista de redes a las que has estado o estas conectado en estos momentos
